                ...
                <div
                    ...
                    <form action="{{ url('/sesi/login') }}" method="post">
                        ...
                        <div class="intro-x mt-8">
                            <input for="username" name="username" id="username" type="text"
                                class="intro-x login__input form-control py-3 px-4 block" placeholder="Email">
                            <input name="password" for="password" id="password" type="password"
                        ...
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            <button class="btn py-3 px-4 w-full xl:w-32 xl:mr-3 align-top"
                                style="background-color: #007bff;" name="submit" type="submit">Login</button>
                            <a class="btn py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top"
                                style="background-color: #007bff;" href="{{ route('register') }}">Register</a>
                        </div>
                    </form>
                </div>
            </div>
