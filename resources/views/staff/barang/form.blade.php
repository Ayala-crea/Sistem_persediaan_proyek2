            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                <div class="intro-y col-span-12 lg:col-span-6">
                    <div class="intro-x box">
                        ...
                        <form action="{{ isset($EditBarang) ? route('simpan.update', $EditBarang->id) : route('barangmasuk.tambah.simpan') }}" method="post">
                            @csrf
                                ...
                                <div class="preview">
                                    ...
                                    <div>
                                        ...
                                        <input id="nama_barang" name="nama_barang" type="text" class="form-control"
                                            ...
                                            value="{{ isset($EditBarang) ? $EditBarang->nama_barang : '' }}">
                                    </div>
                                    <div>
